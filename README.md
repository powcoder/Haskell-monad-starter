...
*  **Lang1.hs eval, Lang2.hs eval and PrinterMonad are required** 
* BareBonesLast 和 TypeclassProblems PrinterMonad，Reader，和State


### 
1. test library：

   1. run `cabal new-update`
   1. run `cabal new-install tasty tasty-hunit --lib` to get the test libraries
